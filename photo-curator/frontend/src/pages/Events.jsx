            ...
            <div key={event.id} className="bg-immich-surface border border-immich-border rounded-xl overflow-hidden">
              ...
              <div className="p-3">
                ...
                <button
                  ...
                  className="mt-3 flex items-center gap-1.5 px-3 py-1.5 bg-immich-primary text-white text-xs font-medium rounded-lg hover:opacity-90 focus-visible:ring-2 focus-visible:ring-immich-primary"
                >
